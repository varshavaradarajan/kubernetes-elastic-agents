...
public class KubernetesInstanceFactory {
    public KubernetesInstance create(CreateAgentRequest request, PluginSettings settings, KubernetesClient client, PluginRequest pluginRequest) throws IOException {
    ...
    private KubernetesInstance createUsingRemoteFile(CreateAgentRequest request, PluginSettings settings, KubernetesClient client, PluginRequest pluginRequest) throws IOException {
        ...
        File podSpecFile = new File("pod_spec");
